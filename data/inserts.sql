...
CALL INSERT_IMAGES('img1_cancun', 'descripción', 1);
CALL INSERT_IMAGES('img2_cancun', 'descripción', 1);
CALL INSERT_IMAGES('img3_cancun', 'descripción', 1);
CALL INSERT_IMAGES('img4_cancun', 'descripción', 1);
CALL INSERT_IMAGES('img5_cancun', 'descripción', 1);
